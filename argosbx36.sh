...
port_xh=$(cat "$HOME/agsbx/port_xh")
vl_xh_link="hysteria2://$uuid@$server_ip:$port_xh?security=tls&alpn=h3&insecure=1&peer=${ym_vl_re}&obfs=none&keepalive=15&mport=$port_xh,26000-27000#${sxname} Hysteria2"
