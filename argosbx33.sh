...
echo "主脚本：bash <(curl -Ls https://raw.githubusercontent.com/hostwebgood/ygkkk-argosbx/refs/heads/main/argosbx33.sh) 或 bash <(wget -qO- https://raw.githubusercontent.com/hostwebgood/ygkkk-argosbx/refs/heads/main/argosbx33.sh)"
